...
if (!url || !authToken) {
  console.error('ERROR: DATABASE_URL and DATABASE_AUTH_TOKEN (or TURSO_DATABASE_URL / TURSO_AUTH_TOKEN) must be set.');
  console.error('Set them in your .env.local or export them before running this script.');
  process.exit(1);
}
