          ...
          {isVerifyingToken ? (
            ...
            <div className="text-center py-4 space-y-5">
              ...
              <button
                ...
                className="w-full py-3 rounded-xl bg-gradient-to-r from-[#05AD98] to-[#038a79] hover:from-[#038a79] hover:to-[#05AD98] text-white text-sm font-bold flex items-center justify-center gap-2 shadow-lg shadow-[rgba(5,173,152,0.25)] transition-all"
              >
