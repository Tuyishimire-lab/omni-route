      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#878787] mt-1">Sign in to your CiteRoute account</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass-panel rounded-2xl p-6 border border-[rgba(187,191,191,0.10)] space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 rounded-xl bg-[#05AD98] hover:bg-[#038a79] text-white text-sm font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
