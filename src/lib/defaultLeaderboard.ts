...
export const DEFAULT_LEADERBOARD_ENTRIES: LeaderboardEntry[] = [
  ...
  { rank: 11, domain: 'linear.app', category: 'SaaS/Tools', geoScore: 91, citationWinRate: 89, zeroClickResilience: 87, trend: 'up', trendDelta: 4, scanCount: 10 },
  { rank: 12, domain: 'hubspot.com', category: 'SaaS/Tools', geoScore: 91, citationWinRate: 87, zeroClickResilience: 85, trend: 'up', trendDelta: 1, scanCount: 12 },
  { rank: 13, domain: 'docker.com', category: 'Developer', geoScore: 90, citationWinRate: 88, zeroClickResilience: 84, trend: 'down', trendDelta: -1, scanCount: 8 },
  ...
  { rank: 20, domain: 'posthog.com', category: 'Developer', geoScore: 88, citationWinRate: 86, zeroClickResilience: 84, trend: 'up', trendDelta: 4, scanCount: 11 },
  { rank: 21, domain: 'postman.com', category: 'Developer', geoScore: 88, citationWinRate: 84, zeroClickResilience: 82, trend: 'flat', trendDelta: 0, scanCount: 8 },
  { rank: 22, domain: 'mistral.ai', category: 'AI/Tech', geoScore: 87, citationWinRate: 86, zeroClickResilience: 85, trend: 'up', trendDelta: 3, scanCount: 6 },
  { rank: 23, domain: 'wise.com', category: 'Fintech', geoScore: 87, citationWinRate: 85, zeroClickResilience: 83, trend: 'up', trendDelta: 1, scanCount: 9 },
  ...
  { rank: 32, domain: 'brex.com', category: 'Fintech', geoScore: 85, citationWinRate: 83, zeroClickResilience: 81, trend: 'up', trendDelta: 3, scanCount: 9 },
  { rank: 33, domain: 'miro.com', category: 'SaaS/Tools', geoScore: 85, citationWinRate: 81, zeroClickResilience: 79, trend: 'up', trendDelta: 2, scanCount: 10 },
  { rank: 34, domain: 'klaviyo.com', category: 'E-Commerce', geoScore: 84, citationWinRate: 82, zeroClickResilience: 81, trend: 'flat', trendDelta: 0, scanCount: 8 },
